...
- `terms.html` is the full Terms of Service (edit the `TERMS` array in the page script).
...
- Accessibility: skip link, `<main>` landmark, keyboard menus (Enter/Space/↓ open, ↑↓ move, Esc closes), contrast lifted on faint greys, alt text on all images.
